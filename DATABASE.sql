...
CREATE TABLE public.transactions (
    ...
    created_at timestamp with time zone DEFAULT '2021-11-29 01:02:01.441868-03'::timestamp with time zone NOT NULL,
...
ALTER TABLE ONLY public.transactions
    ADD CONSTRAINT transactions_fk0 FOREIGN KEY (user_id) REFERENCES public.users(id);
